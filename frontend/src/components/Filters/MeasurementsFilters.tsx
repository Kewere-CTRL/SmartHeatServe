        ...
        <div>
            ...
            <div className="flex flex-wrap space-x-4 mt-3">
                ...
                <div className="relative" ref={dateRef}>
                    ...
                    {isDateOpen && (
                        <div className="absolute z-20 bg-white p-4 mt-2 shadow-md border border-gray-300 rounded">
                            <Tooltip
                ...
                <div className="relative" ref={timeRef}>
                    <button
                        ...
                        className="flex items-center text-black px-4 py-1 rounded-full border border-black"
                    >
                        {"Время"} {isTimeOpen ? <FaChevronUp className="ml-1"/> :
                        <FaChevronDown className="ml-1"/>}
                    </button>
                ...
                <div className="relative" ref={tempRef}>
                    <button
                        ...
                        className="flex items-center text-black px-4 py-1 rounded-full border border-black"
                    >
                        {"Отклонение t°"} {isTempOpen ? <FaChevronUp className="ml-1"/> :
                        <FaChevronDown className="ml-1"/>}
                    </button>

                    {isTempOpen && (
                        <div className="w-[230px] absolute z-20 bg-white p-4 mt-2 shadow-md border border-gray-300 rounded">
                            <Tooltip
                ...
                <div className="relative" ref={humidityRef}>
                    <button
                        ...
                        className="flex items-center text-black px-4 py-1 rounded-full border border-black"
                    >
                        {"Отклонение h"} {isHumidityOpen ? <FaChevronUp className="ml-1"/> :
                        <FaChevronDown className="ml-1"/>}
                    </button>
