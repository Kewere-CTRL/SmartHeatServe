...
export const transformBuildingData = (building: Building) => {
    return [
        ...
        { id: 4, title: 'Строительный объем', value: building.constructionVolume  || 'Не указан' },
        { id: 5, title: 'Отапливаемая площадь', value: building.heatedArea  || 'Не указан' },
        ...
        { id: 8, title: 'Показатель компактности', value: building.compactnessIndicator || 'Не указан' },
